...
export const metadata: Metadata = {
  ...
  // PWA install support. The manifest itself is generated by app/manifest.ts
  // (Next.js App Router idiom → served at /manifest.webmanifest). This block
  // adds icon references + iOS Safari install hints that don't live in the
  // manifest.
